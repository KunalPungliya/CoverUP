    ...
    return (
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">Analytics & ROI</h1>
            <p className="text-xs text-slate-500 mt-0.5">Deep dive into AI recovery performance and financial impact</p>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center p-16 bg-white rounded-2xl border border-slate-200 text-center shadow-2xs">
          <div className="bg-blue-50 border border-blue-100 p-5 rounded-2xl mb-4 text-blue-600 shadow-2xs">
            <Database className="h-10 w-10" />
          </div>
          <h2 className="text-lg font-bold text-slate-900 mb-1">No Analytics Batches Found</h2>
          ...
          <Link href="/">
            <Button variant="default" className="gap-2">
              <Zap className="h-4 w-4 fill-current" /> Run Recovery Batch Now
            </Button>
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">Analytics & ROI</h1>
          <p className="text-xs text-slate-500 mt-0.5">Recovery performance intelligence, AI certainty distributions, and ARR projections</p>
        </div>
        ...
        <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200 self-start sm:self-auto">
          ...
          >
            <Activity className="h-3.5 w-3.5" /> Performance & Insights
          </button>
          <button
          ...
          >
            <Calculator className="h-3.5 w-3.5" /> Financial ROI Model
          </button>
        </div>
      </div>
      ...
      {activeTab === 'insights' ? (
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500">Avg Recovery Rate</p>
            ...
            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500">Avg AI Confidence</p>
                    <h3 className="text-xl font-bold text-blue-600 mt-0.5">{metrics.avgAiConfidence}%</h3>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500">Top Failure</p>
                    <h3 className="text-sm font-bold text-slate-900 truncate max-w-[130px] mt-0.5" title={metrics.mostCommonFailure}>
            ...
            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500">Best Strategy</p>
                    <h3 className="text-sm font-bold text-slate-900 truncate max-w-[130px] mt-0.5" title={metrics.bestActionType}>
          ...
          {/* AI Insights Callout */}
          <Card className="bg-blue-50/40 border-blue-200/80 shadow-2xs">
            <CardHeader className="pb-2">
              <div className="flex items-center gap-2">
                <Lightbulb className="h-4 w-4 text-blue-600" />
                <CardTitle className="text-sm font-bold text-blue-950">AI Automated Insights</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <ul className="space-y-1.5">
                {insights.map((insight, idx) => (
                  <li key={idx} className="flex items-start gap-2 text-blue-900 text-xs">
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                ...
                <p className="text-2xl font-bold text-slate-900 mt-1">{formatCurrency(ltvPreserved)}</p>
                <p className="text-[11px] text-slate-400 mt-0.5">over {customerLifeMonths} month avg lifetime</p>
              </CardContent>
            </Card>

            <Card className="hover:border-slate-300 transition-all">
              <CardContent className="p-4">
                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Net ROI Multiplier</p>
                <p className="text-2xl font-bold text-blue-600 mt-1">{roiMultiplier}x</p>
                <p className="text-[11px] text-slate-400 mt-0.5">vs traditional recovery ops</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 space-y-4">
              <Card>
                <CardHeader className="pb-3 border-b border-slate-100">
                  <CardTitle className="text-sm font-bold text-slate-900">Interactive Business Variables</CardTitle>
                ...
                <CardContent className="pt-4 space-y-5">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <label htmlFor={mrrSliderId} className="font-semibold text-slate-700">Monthly Recurring Revenue (MRR)</label>
                      <span className="font-bold text-blue-600 text-sm">{formatCurrency(mrr)}</span>
                    </div>
                    <input
                      id={mrrSliderId}
                      type="range"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <label htmlFor={churnSliderId} className="font-semibold text-slate-700">Payment Failure Rate</label>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <label htmlFor={recoverySliderId} className="font-semibold text-slate-700">CoverUP Autonomous Recovery Rate</label>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <label htmlFor={ltvSliderId} className="font-semibold text-slate-700">Average Customer Lifetime</label>
                      <span className="font-bold text-slate-900 text-sm">{customerLifeMonths} months</span>
                    </div>
                    <input
                      id={ltvSliderId}
                      type="range"
            ...
            <div className="lg:col-span-6 space-y-4">
              <Card>
                <CardHeader className="pb-3 border-b border-slate-100">
                  <CardTitle className="text-sm font-bold text-slate-900">Cumulative Revenue Impact</CardTitle>
                  <CardDescription>Lost revenue without recovery vs recaptured by CoverUP (₹ Thousands)</CardDescription>
                </CardHeader>
                <CardContent className="pt-4">
                  ...
                  <div className="pt-3 mt-3 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-xs text-slate-500">Ready to test live recovery on your cohort?</span>
                    <Link href="/">
